...
| **TODO-104** ⬅️ **SUYA** | **LN-617/628** (lo que ya decidió: `§ADR-132`): ① ¿E01-E06, E09, E24? ¿recorrido fuera del tramo 618? ② «ER» y función de cada torre ③ conductor e hipótesis ④ LN-628: 185 h no «Actual» ⑤ picos 16-02 y 07-02 | Sin ①② no se estrena un nombre |
...
|---|---|---|
| **TODO-105** 🔴 | **Torre común**: ADR y MAQUETAS (alta de línea, línea sin conductor, torre de dos circuitos, parque, varias líneas); luego su alta y el SCADA ya procesado | `§ADR-132` |
