...
| **TODO-73** | **Cable de guarda: HECHO y EN PRODUCCIÓN** (`99 §ADR-044`). E06-E09 y E21-E22 declarados y pintados en el mapa: 902 m, 29,8 %. **Falta lo que solo sabes tú:** ¿el RESTO de la línea sí lleva? Quedan **20 vanos en «no consta»**, que NO es «lo lleva» — se declaran en Detalle GPS, vano a vano | Mientras sigan en «no consta», el 29,8 % es sobre lo que hay declarado, no un veredicto de la línea |
