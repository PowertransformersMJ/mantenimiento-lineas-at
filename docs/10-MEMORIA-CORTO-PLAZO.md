...
| **TODO-73** | **Cable de guarda de LN-627 (dato suyo, 21-08): ¿DISEÑO o DEFECTO?** ¿Lleva el resto de la línea? ¿El guarda muere en los apoyos de los extremos? El dato, lo medido y las tres preguntas están en la **bóveda** (`datos-campo/2026-08-21-cable-de-guarda.md`) y **no en este repo, que es público**: describe dónde una línea en servicio no tiene protección. Publicarlo lo decide él | Es prerrequisito de `nFasesAmarradas` (`TODO-57`) y cambia la memoria de cantidades. Hoy no mueve ningún veredicto |
