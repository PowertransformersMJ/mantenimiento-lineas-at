...
| **TODO-74** ⚠️ | **EL MOTOR NO SABE REPRESENTAR UN APOYO MIXTO** (`99 §ADR-017`, deuda del 21-08). Él aclaró que el guarda quedó **recogido y amarrado a la estructura**: en esos apoyos las fases SIGUEN y el guarda TERMINA. El eje tiene dos casos y los dos suponen que TODOS los conductores están en el mismo. Sale un número CORTO → «cumple» de más | **Antes de que él llene `nFasesAmarradas` (`TODO-57`)**: en esos apoyos el veredicto saldría optimista sin que nadie lo note. Falta también saber si el guarda quedó TENSO o flojo |
