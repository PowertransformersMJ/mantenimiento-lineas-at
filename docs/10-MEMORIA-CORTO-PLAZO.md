...
| **TODO-73** | ✅ **CERRADO — la línea está declarada ENTERA** (`99 §ADR-044`): 24/24 vanos con respuesta, 4 sin guarda (E06-E09 y E21-E22, 902 m, 29,8 %) y 20 con guarda. Se ve en el mapa. **Queda una pregunta más fina:** ¿el guarda MUERE en E06, E09, E21 y E22? Eso lo deduzco yo del dato, no lo has dicho | Si muere ahí, esos 4 apoyos se llevan su tiro por UN SOLO lado — y eso sí entra al eje longitudinal vía `nFasesAmarradas` |
