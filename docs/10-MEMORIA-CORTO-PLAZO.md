...
| **TODO-73** | **Declarar el cable de guarda vano a vano** en «Detalle GPS» → el mapa lo pinta solo (`99 §ADR-044`). Él ya dijo lo esencial: **no es diseño, es daño de operación**, y son E06-E09 y E21-E22 (903 m, 29,9 %). Falta METERLO: el dato está en la **bóveda**, no en este repo público. Y quedan 20 vanos en «no consta», que NO es «lo lleva» | Sin el dato el mapa no pinta nada. Es prerrequisito de `nFasesAmarradas` (`TODO-57`) |
