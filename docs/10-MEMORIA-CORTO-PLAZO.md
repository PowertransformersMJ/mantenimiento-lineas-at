...
| **TODO-73** | **¿El cable de guarda MUERE en E06, E09, E21 y E22?** SIGUE ABIERTA: preguntó por «retenida o herraje de anclaje» y él contestó lo primero —**ningún apoyo tiene retenida, todos autosoportados** (21-08)—, que **no lo decide**: un autosoportado ancla el guarda igual. Su dato, y lo que sí cierra, en la bóveda (`datos-campo/2026-08-21-apoyos-autosoportados.md`) | Si el guarda muere ahí, esos 4 apoyos se llevan su tiro por UN SOLO lado — entra al eje longitudinal vía `nFasesAmarradas` (`TODO-57`) |
