...
| # | Qué | Por qué importa |
|---|---|---|
| **TODO-97** 🔴 ⬅️ **EL CORTE DE ACCESO** (`§ADR-100`) | Construido y verde, **sin desplegar**. Runbook en `usuarios/README.md §9`. Pasos 0 y 1 ✅ (registro público CERRADO, verificado: `ADMIN_ONLY_OPERATION`). Consola con pantallazos: sign-up OFF · cuenta de servicio · Add user · apagar Google | Sin el paso 0 nada arranca |
