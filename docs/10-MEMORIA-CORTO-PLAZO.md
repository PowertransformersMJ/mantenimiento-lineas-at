...
| # | Qué | Por qué importa |
|---|---|---|
| **TODO-97** 🔴 ⬅️ **EL CORTE DE ACCESO** (`§ADR-100`) | Construido y verde, **sin desplegar**. Runbook en `usuarios/README.md §9`. Pasos 0-5 ✅ (registro CERRADO · Workers desplegados · propietario creado en consola · web SIN Google servida). Consola con pantallazos: sign-up OFF · cuenta de servicio · Add user · apagar Google | Sin el paso 0 nada arranca |
