...
| # | Qué | Por qué importa |
|---|---|---|
| **CLAVE** | **Ponerse contraseña.** La llave admin no está en Descargas: regenerarla (Consola Firebase → Cuentas de servicio), guardarla fuera y `usuarios.mjs contrasena … --definitiva` | Desbloquea retirar Google (2b) |
...
| **TODO-95** 🔴 ⬅️ **SUYA, URGENTE** | **¿De qué FABRICANTE es el conductor, y dónde su ficha?** Desde `§ADR-098` manda la ficha. **CENTELSA da el Darien a 75 °C máx / 665 A; el motor usa 90 °C y publica 718 A** | Si el cable es de CENTELSA, **17 % de capacidad de MÁS** publicada |
| **TODO-96** ⬅️ **SUYA** | **¿El AAAC sin ficha baja de 90 °C a 75 °C?** Siete fichas dicen 75 °C para el Darien. Un defecto optimista no es conservador, pero bajarlo **cambia el veredicto de toda línea sin ficha** (`§ADR-098`) | 718 A → **611 A** |
...
La línea → `40 §10`, `99 §ADR-013/017` · las 205 fotos → `§ADR-031` · IDEAM (sin rayos) →
