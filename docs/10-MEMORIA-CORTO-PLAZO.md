...
| **TODO-82** | **¿Quinto atlas de NUBOSIDAD?** `CLOUD_AMT` existe por horas pero solo llega a **finales de mayo** (verificado 22-08). Lo único que diría «nublado»: de los mm NO sale, y **«tormenta eléctrica» no existe en esta fuente**. · **¿Y la FASE 2 del pronóstico?** (`§ADR-057`). Hoy la capa ya no miente, pero sigue sin contestar tres preguntas suyas: pasar de «día» a **franja mañana/tarde** (los bloques de 6 h de la fuente caen exactos en 07–13 y 13–19 de Colombia, para los 11 días), **sensación térmica** y UV, la **hora** a la que empieza la lluvia (ya se calcula en `proximasHoras` y no se pinta), y decir que el viento publicado es **sostenido, no racha** | El 24-08 la sensación llegaba a **40 °C** con el aire a 32,5: el riesgo de la cuadrilla es invisible en pantalla |
