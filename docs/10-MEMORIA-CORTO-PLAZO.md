...
| # | Qué | Por qué importa |
|---|---|---|
| **TODO-97** 🔴 ⬅️ **EL CORTE DE ACCESO** (`§ADR-100`) | Construido y verde, **sin desplegar**. Runbook en `usuarios/README.md §9`. Pasos 0-7 ✅ (registro CERRADO · Workers · propietario ARRANCADO, cerrojo puesto · web SIN Google · reglas nuevas publicadas). Faltan 8-10: sign-up OFF · cuenta de servicio · Add user · apagar Google | Sin el paso 0 nada arranca |
