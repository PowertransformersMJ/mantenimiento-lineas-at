...
| **TODO-73** | **¿El cable de guarda MUERE en E06, E09, E21 y E22?** La línea ya está declarada entera (`99 §ADR-044`: 24/24 vanos, 902 m sin guarda = 29,8 %, se ve en el mapa). Lo que falta es el LÍMITE: que el guarda se ancle en esos cuatro apoyos lo deduzco yo del dato, no lo has dicho tú. ¿Tienen retenida o herraje de anclaje? | Si muere ahí, esos 4 apoyos se llevan su tiro por UN SOLO lado — y eso sí entra al eje longitudinal vía `nFasesAmarradas` (`TODO-57`) |
