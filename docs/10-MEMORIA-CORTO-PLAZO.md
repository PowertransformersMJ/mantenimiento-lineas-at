...
| **TODO-104** ⬅️ **SUYA** | **LN-617/628** (lo que ya decidió: `§ADR-132`): ① ¿E01-E06, E09, E24? ¿recorrido fuera del 618? ② función de cada torre (alta SIN torres hasta entonces) ③ conductor e hipótesis ④ LN-628: 185 h no «Actual» ⑤ picos 16-02 y 07-02 | Sin ①② no se estrena un nombre |
...
|---|---|---|
| **TODO-105** 🔴 | **Torre común**: ADR-133 (propuesto) y MAQUETAS (alta, línea sin torres, parque, varias líneas, informe); luego su alta y el SCADA | `§ADR-132` |
