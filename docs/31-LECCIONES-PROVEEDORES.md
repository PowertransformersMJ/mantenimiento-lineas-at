...
### L-78 · Antes de comprar una norma o un sensor para diagnosticar LN-627: lo que es gratis, lo que es de pago y lo que no aplica

- **Síntoma:** cinco frentes de investigación (2026-09-02) trajeron normas y herramientas; varias son de pago y otras se ofrecen como imprescindibles cuando para 3,03 km y presupuesto cero no lo son.
- **Gratis y con licencia que permite uso comercial (verificado):** **NASA POWER** horario (temperatura, viento, sol; CC BY 4.0; probado en vivo lat 10,9/lon −74,8, HTTP 200 sin clave) — ya es proveedor del atlas (`99 §ADR-055`); la temperatura sirve para la ampacidad ajustada al ambiente, **el viento NO** (`40 §4.3.1`). **CNAIM** (metodología británica DNO v2.1 2021, paquete R en CRAN): la función `pof_ohl_cond_132_66_33kv` toma material AAAC, distancia a la costa, índice de corrosión 1-5, edad, condición visual en 4 niveles y **número de empalmes** — se toma la ESTRUCTURA (qué variables entran), **nunca los coeficientes**, calibrados con la red británica — https://rdrr.io/cran/CNAIM/man/pof_ohl_cond_132_66_33kv.html . **ERA5** (Copernicus): CC-BY desde 02-07-2025 según anuncio ECMWF, **NO VERIFICADO** (servidor caído).
- **De pago, y la vía barata:** **CIGRÉ TB 905** (WG B2.68, 2023, 187 pp., «Conductor condition assessment and life extension, Vol. 1») y **TB 244** (uprating, 2004): 300 USD para no miembros, **gratis si el empleador está afiliado a CIGRÉ Colombia** — verificarlo cuesta un correo — https://www.e-cigre.org/publications/detail/905-sustainability-of-overhead-line-conductors-and-fittings-conductor-condition-assessment-and-life-extension-volume-1-state-of-the-art.html . **TB 273** (H/w): la copia leída es espejo en IEEE TPC; para un informe firmable, el original. **ISO 9223:2012** (de pago; la vista previa oficial de iTeh trae las tablas y ecuaciones que `40 §11` usa — https://www.iso.org/standard/53499.html). **IEC 60826:2017** (solo vista previa de la 2003 leída). **IEC TS 60815-1 Ed. 2.0 (24-11-2025)** — si se discute aislamiento, se compra ésta, no se usa la memoria de 2008. **CIGRE TB 601** (thermal rating, 2014, ~180 €): no abierta. **IEEE 1283-2013** y **738-2023**: no abiertas.
- **NO se compra, con el porqué:** sensores de ampacidad dinámica (precio de prensa ~30.000 USD/sensor, NO VERIFICADO; compran 6-14 % sobre lo que la temperatura horaria da gratis) · monitoreo sin contacto tipo LineVision y fibra/FBG (cuota anual por vano) · robots sobre conductor (735 kV, haces) · LiDAR aerotransportado para 3 km (±15 cm en el cable, pero su problema medido es la cota del terreno, ±8 m) · helicóptero · certificación ISO 55001 (auditoría paga; las cuatro ideas útiles son gratis) · diagnósticos de alma de acero (CDIS, reflectometría: su AAAC no tiene alma) · ensayo de niebla salina (califica conductor NUEVO) · costes por km de dron/helicóptero de blogs de vendedores (marketing, no se negocia con eso).
- **Sí vale la pena y es barato:** dron de consumo para **cota del terreno y base de los 26 apoyos** por fotogrametría (Fryskowska, *Sensors* 19(3):700, 2019: flecha a ~10 % del láser; **no** para reconstruir el conductor, que la fotogrametría hace mal por física) — https://pmc.ncbi.nlm.nih.gov/articles/PMC6387407/ ; probetas de zinc/acero ISO 9226 un año; captador de cloruros de vela húmeda; cámara de corona alquilada para una pasada (`40 §5`).
