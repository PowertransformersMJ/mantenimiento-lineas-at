...
| **Build** | 🟢 `npm test` **1.896 pass / 0 fail** · `contrato:verificar` exit 0, **contrato v0.9.0** · motor v0.3.0 · verificado-vivo: 2026-08-23 |
| **Repo** | `main` · https://github.com/PowertransformersMJ/mantenimiento-lineas-at · **PÚBLICO** (decisión del Ingeniero 2026-07-29) |
| **Producción** | 🟢 **https://mantenimiento-lineas-at.pages.dev** — Cloudflare Pages (`ajimenezp99@gmail.com`). **A mano**, `build` delante: `deploy` NO construye (`32 · L-35`). Cargados el pórtico de ORIGEN y un empalme (`ADR-054`): **30 puntos · 26 estructuras · 3.032,8 m**. Los CINCO atlas entran al mapa como dato del sitio y **el clima vive en el Atlas** (`ADR-055..069`), con **el trazado de la línea dibujado encima** (`ADR-074`). Desde el 24-08 la pantalla dice **de cuándo es el dato** —archivo y medida, con hora— y el vigía mira **cada 4 h** (`ADR-075`). Medido: temperatura, viento y lluvia hasta **2026-08-21**; sol y nubes hasta **2026-05-30**, que es hasta donde publica su fuente. **hash y cinta verificados en vivo con su sesión** · verificado-vivo: 2026-08-24 |
