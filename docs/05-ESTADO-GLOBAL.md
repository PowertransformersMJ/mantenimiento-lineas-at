...
| **Build** | 🟢 `npm test` **1.719 pass / 0 fail** · `contrato:verificar` exit 0, **contrato v0.7.0** · verificado-vivo: 2026-08-22 |
| **Repo** | `main` · https://github.com/PowertransformersMJ/mantenimiento-lineas-at · **PÚBLICO** (decisión del Ingeniero 2026-07-29) |
| **Producción** | 🟢 **https://mantenimiento-lineas-at.pages.dev** — Cloudflare Pages, cuenta `ajimenezp99@gmail.com`. **Piel CLARA** desde el 04-08. **Se despliega a mano** y `build` va delante: `deploy` NO construye (`32 · L-35`). Último: **las señales de la página dejan de mentir** —banda, color de pestaña, tope de tiro y versión del motor, todos derivados del dato (`ADR-051`)—, tras el atlas solar y la capa de radiación (`ADR-045/046`). Recorrido en vivo con su sesión. **Hash servido == construido.** · verificado-vivo: 2026-08-22 |
