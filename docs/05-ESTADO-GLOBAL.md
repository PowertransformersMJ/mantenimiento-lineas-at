...
| **Build** | 🟢 `npm test` **2.213 pass / 0 fail** · `contrato:verificar` exit 0, **contrato v0.12.0** · motor v0.11.0 · verificado-vivo: 2026-09-01 |
...
| **Backend** | 🟢 **Un solo trabajador**: el portero de fotos (`evidencias/`) delante de un R2 privado (ADR-010). Datos en **Firestore** con RBAC por *claims*; **el ingreso exige contraseña, sin registro público** (ADR-019). **Residencia aceptada, São Paulo** · 🔒 **freno de borrado PUESTO** · ⚠️ sin copia (30-08, `ADR-089`). |
