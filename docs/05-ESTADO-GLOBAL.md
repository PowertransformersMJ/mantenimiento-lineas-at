...
| **Build** | 🟢 `npm test` **785 pass / 0 fail** (núcleo · exportes · vistas · método RCA · y por fin el CONTRATO, que hasta el 05-08 no se podía ejecutar en una prueba, `33 · L-41`). · verificado-vivo: 2026-08-05 |
