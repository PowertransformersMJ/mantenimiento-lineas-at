...
| **Build** | 🟢 `npm test` **2.120 pass / 0 fail** · `contrato:verificar` exit 0, **contrato v0.10.0** · motor v0.7.0 · verificado-vivo: 2026-08-30 |
...
| **Backend** | 🟢 **Un solo trabajador**: el portero de fotos (`evidencias/`) delante de un R2 privado (ADR-010). Datos en **Firestore** con RBAC por *claims*; **el ingreso exige contraseña, sin registro público** (ADR-019). **Residencia aceptada, São Paulo** · ⚠️ **sin copia ni freno de borrado** (medido 30-08, `ADR-089`). |
