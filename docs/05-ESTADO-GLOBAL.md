...
| **Deuda crítica** | 🔴 **El DATO de la ficha de los 24 apoyos** (`TODO-57`): la pantalla para meterlo ya existe (`ADR-030`), el dato no. 🔴 **El acta NO marca aún los veredictos calculados sobre datos SUPUESTOS** (`TODO-70`): un «cumple» sobre una altura estimada a ojo saldría limpio en un papel firmado. 🟡 Dónde deben vivir los datos del empleador (`TODO-58`). (✅ motor sin deuda desde 07-29, `40 §8` · ✅ Consejo Externo, ADR-002 · ✅ alcance y presupuesto, ADR-003 · ✅ contexto real fijado, **ADR-022**: sin cliente ni contrato — `TODO-02` retirado por falta de objeto.) |
