...
| **Producción** | 🟢 **https://mantenimiento-lineas-at.pages.dev** — Cloudflare Pages, cuenta `ajimenezp99@gmail.com`. **Piel CLARA** desde el 04-08. **Se despliega a mano** y `build` va delante: `deploy` NO construye (`32 · L-35`). Último: **el atlas solar** (`#/sol`) y **la capa de radiación, que por fin se aprecia** —encuadre al recorte y escala ajustada al dato— (`ADR-045/046`). Recorrido en vivo con su sesión. **Hash servido == construido.** · verificado-vivo: 2026-08-21 |
