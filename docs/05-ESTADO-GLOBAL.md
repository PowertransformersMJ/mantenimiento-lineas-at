...
| **Producción** | 🟢 **https://mantenimiento-lineas-at.pages.dev** — Cloudflare Pages, cuenta `ajimenezp99@gmail.com`. **Piel CLARA** desde el 04-08 («El Horizonte» F3). **Se despliega a mano** (`build` delante: `deploy` NO construye, `32 · L-35`); el automático espera 2 secretos. **Contrato v0.6.0**, ficha editable y marca de dato SUPUESTO (`ADR-032`) dentro: desplegado el 19-08, **hash del bundle servido == el construido**. Prueba lo SERVIDO; lo que él ve al entrar exige su Chrome. · verificado-vivo: 2026-08-19 |
