...
| **Build** | 🟢 `npm test` **2.521 / 0 fail** + emulador 54/54 · contrato exit 0, **v0.15.0** · motor v0.13.0 · verificado-vivo: 2026-09-07 |
...
| **Backend** | 🟢 **Dos trabajadores vivos**: el portero de fotos (`evidencias/`, ADR-010) y el de personas (`usuarios/`, ADR-100). **Firestore**; permisos en el token; **UNA cuenta (el propietario), contraseña, sin Google ni registro** (ADR-019/100/101). **Residencia aceptada, São Paulo** · 🔒 **freno de borrado PUESTO** · ⚠️ sin copia (30-08, `ADR-089`). |
